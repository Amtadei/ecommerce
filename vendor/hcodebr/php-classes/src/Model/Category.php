...
class Category extends Model {
	...
	public static function listAll() {
		...
		return $sql->select("SELECT * FROM db_ecommerce.tb_categories ORDER BY descategory");
	...
	public function delete() {
		...
		$results = $sql->query("DELETE FROM db_ecommerce.tb_categories WHERE idcategory = :idcategory", [
			":idcategory"=>$this->getidcategory()
		]);
	...
	public function getProductsPage($page = 1, $itensPerPage = 3) {
		...
		$results = $sql->select("
			...
			FROM db_ecommerce.tb_products a
			INNER JOIN db_ecommerce.tb_productscategories b ON a.idproduct = b.idproduct
			INNER JOIN db_ecommerce.tb_categories c ON c.idcategory = b.idcategory
	...
	public function addProduct(Product $product) {
		...
		$sql->query("INSERT INTO db_ecommerce.tb_productscategories (idcategory, idproduct)
	...
	public function removeProduct(Product $product) {
		...
		$sql->query("DELETE FROM db_ecommerce.tb_productscategories
	...
	public static function getPage($page = 1, $itensPerPage = 10) {
		...
		$results = $sql->select("
			SELECT SQL_CALC_FOUND_ROWS * 
			FROM db_ecommerce.tb_categories 
